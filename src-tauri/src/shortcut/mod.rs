...
#[tauri::command]
#[specta::specta]
pub fn change_voiceflow_endpoint_setting(app: AppHandle, endpoint: String) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.voiceflow_endpoint = endpoint;
    settings::write_settings(&app, settings);
    Ok(())
}
...
#[tauri::command]
#[specta::specta]
pub fn change_voiceflow_token_setting(app: AppHandle, token: String) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.voiceflow_token = token;
    settings::write_settings(&app, settings);
    Ok(())
}
...
#[tauri::command]
#[specta::specta]
pub fn change_privacy_mode_setting(app: AppHandle, enabled: bool) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
